...
public class CustomAlertBlockRenderer : HtmlObjectRenderer<Markdig.Extensions.Alerts.AlertBlock>
{
    ...
    /// </summary>
    public CustomAlertBlockRenderer()
    {
    ...
    /// <inheritdoc />
    protected override void Write(HtmlRenderer renderer, Markdig.Extensions.Alerts.AlertBlock obj)
    {
        renderer.EnsureLine();
        if (renderer.EnableHtmlForBlock)
        {
            renderer.Write("<div class=\"not-prose\">");
            renderer.Write("<div");
